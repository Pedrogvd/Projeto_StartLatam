...
As variáveis são utilizadas para guardar valores de um algoritmo. Cada dado pode ser de um tipo
...
Um exemplo de Entrada e Saída de dados são as palavras reservadas Escreva e Leia. Exemplo de
Saída de Dados:
